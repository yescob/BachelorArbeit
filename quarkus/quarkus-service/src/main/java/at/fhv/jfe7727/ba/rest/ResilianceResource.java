...
public class ResilianceResource {
    ...
    private static final Logger LOGGER = Logger.getLogger(ResilianceResource.class);
    ...
    public Response getAllMovies() {
        maybeFail();
        LOGGER.infof("GET All Movies accessed");
    ...
    public Response getAllPersons() {
        ...
        try {
            maybeTimeOut();
            LOGGER.infof("GET All Persons accessed");
            return personRestClient.getAllPersons();
        } catch (InterruptedException e) {
            LOGGER.error("GET All Persons timed out");
            return null;
        }
    }
